...
# producto
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Avena', '2', '2', '1');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Queso', '4', '6','2');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Kiwi', '5', '0.50','3');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Coco', '2', '2.3','4');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Leche', '4', '2.2','5');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Agua', '3', '1.5','6');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Jugo de Naranja', '3', '1.8', '7');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Manzanas', '5', '0.5','8');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Peras', '5', '1.18', '9');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Uvas', '5', '3.5', '10');
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`, `idProducto`) VALUES ('Jugo de Manzana', '3', '1.6', '11');
# factura
